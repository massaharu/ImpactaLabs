...
<script type="text/javascript">
	...
	//CONSTANTS
		...
		/*$uploadform = '<div id="maindiv"><form id="myForm" enctype="multipart/form-data"'+
			 'action="/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/exemplo_itau.php" method="post">'+
				'<p>'+
	...
	//STORES
		var storearquivoretorno_list = new Ext.data.JsonStore({
				url:'/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/json/arquivoretorno_list.php',
				root:'myData',
			...
			var storearquivoretornotransacaobyarquivo_list = new Ext.data.JsonStore({
				url:'/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/json/arquivoretornotransacao_list.php',
				root:'myData',
			...
			var storearquivoocorrencias_list = new Ext.data.JsonStore({
				url:'/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/json/arquivoocorrencias_list.php',
				root:'myData',
		...
		var mainWin = new Ext.Window({
			title:'Baixa Arquivo Retorno (CNAB 400) Itaú v7',		
								...
								bbar:['Cod. Ocorrência: ',{
									...
									handler:function(){
										...
										if(fn_validFields('nrcodocorrencia') && fn_validFields('txtocorrencia')){
											Ext.Ajax.request({ 
												url:'/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/ajax/arquivoocorrencias_save.php',
												params:{
									...
									handler:function(){
										Ext.Ajax.request({ 
											url:'/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/ajax/arquivoocorrencias_delete.php',
											params:{
				...
				'afterrender':function(){
					...
					var file = function(file){
						...
						var upload_file = function(File, new_name){
							...
							xhr.open('POST', '/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/exemplo_itau.php', true);
									...
									if(result.success){
										...
										$('#file_to_input').next().fadeOut(2000, function(){
											Ext.MessageBox.info("Arquivo salvo e processado com sucesso!"," Clique em OK para visualizar os pagamentos baixados/não baixados.", function(){
												Ext.Ajax.request({
													url:'/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/ajax/pagamentoBaixaBoleto_load.php',
													params:{
															...
															var winPagamentoNaoBaixado = new Ext.Window({
																...
																-				
																				...
																				if($hasSessionid){
																					if(!$isAllPago){
																						Ext.Ajax.request({
																							url:'/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/ajax/pagamentoBaixaBoleto_save.php',
																							params: {
