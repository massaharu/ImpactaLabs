...
if(move_uploaded_file($fileName["tmp_name"], utf8_decode( "//opel/corporate/Simpac Web Site/simpacweb/labs/Massaharu/extjsTelas/19.BoletoPhp/Retorno-BoletoPHP-master/uploaded/").$fileName['name'])){
