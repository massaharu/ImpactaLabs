...
<script>
	$(function(){
		...
		Mousetrap.bind('ctrl+shift+left', function(e, combo) {
			...
			if(linha){
				$('html,body').animate({ scrollTop: parseInt($('#turma-'+linha).offset().top)}, 0);
			}
		});
	})
</script>
...
$a = pg_query(conectaiclass("idigitalclass"),"SELECT table_schema,table_name
