...
require_once("class.RetornoCNAB240.php");
require_once("class.RetornoCNAB400Conv6.php");
require_once("class.RetornoCNAB400Conv7.php");
require_once("class.RetornoCNAB400Bradesco.php");
require_once("class.RetornoCNAB400ItauV7.php");
		...
		if($arq = fopen($fileName, "r")) {
			...
			if($linha = fgets($arq, 500)) {
				...
				if($len >= 240 and $len <= 242)
					...
					if(strstr($linha, "ITAU"))
						return new RetornoCNAB400ItauV7($fileName, $aoProcessarLinhaFunctionName);	
